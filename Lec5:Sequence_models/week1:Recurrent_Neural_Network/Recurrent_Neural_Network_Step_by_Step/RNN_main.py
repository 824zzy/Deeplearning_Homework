...
""" Forward propagation for basic Recurrent Neural Network """
...
# # test case for rnn cell forward
# np.random.seed(1)
...
# # test case for lstm cell forward
# np.random.seed(1)
# xt = np.random.randn(3,10)
# a_prev = np.random.randn(5,10)
