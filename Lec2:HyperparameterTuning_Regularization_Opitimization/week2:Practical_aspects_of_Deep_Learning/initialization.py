...
train_X, train_Y, test_X, test_Y = load_dataset(pltShow=False)
plt.close()
...
def model(X, Y, learning_rate=0.01, num_iterations=15000, print_cost=True, initialization="he"):
    ...
    m = float(X.shape[1])  # number of examples
...
# # test case for initialize_with_zero
# parameters = model(train_X, train_Y, initialization = "zeros")
# print ("On the train set:")
# predictions_train = predict(train_X, train_Y, parameters)
# print ("On the test set:")
# predictions_test = predict(test_X, test_Y, parameters)
# # show plt:Model with Zeros initialization
# # todo: if you want to show data in limited axes and show plot boundary.
...
# # test case for he initialization
