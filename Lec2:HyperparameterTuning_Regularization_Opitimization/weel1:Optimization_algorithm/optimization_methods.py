...
def random_mini_batches(X, Y, mini_batch_size=64, seed=0):
    ...
    # Step 1: Shuffle (X, Y)
    # todo: https://blog.csdn.net/lyy14011305/article/details/76207327
...
# # test case for mini-batch gradient descent
...
# # test case for initialize velocity
...
""" implement model with different optimization algorithms """
# dataset
train_X, train_Y = load_dataset(pltShow=False)
plt.close()
...
# # test case for Mini-batch gradient descent with momentum
# # train 3-layer model
# layers_dims = [train_X.shape[0], 5, 2, 1]
...
# # test case for Mini-batch gradient descent with Adam mode
# # train 3-layer model
# layers_dims = [train_X.shape[0], 5, 2, 1]
